...
**Council sessions:**
- `agents/runtime/council/sessions/senior-personas-map-iter1.json` (map iter-1, Anthropic + GPT-4o, $0.0992) <!-- council-ref-allowed: persona-map decision trace -->
- `agents/runtime/council/sessions/joint-wing3-wing4-iter2.json` (joint Wing 3 + Wing 4 iter-2, Anthropic + GPT-4o, $0.1529) <!-- council-ref-allowed: persona-map decision trace -->
...
Council session: `agents/runtime/council/sessions/senior-personas-map-iter1.json`. <!-- council-ref-allowed: persona-map decision trace -->
