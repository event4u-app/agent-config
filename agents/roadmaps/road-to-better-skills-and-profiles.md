...
- [x] **B** — Skill reorg complete (block marker; flips when B1–B3 are done **in this plate** + B4 ships in Plate+1). Gated on `road-to-post-pr29-optimize.md` Phase 1 shipping. *(B1–B3 landed; B4 explicitly deferred to Plate+1.)*
