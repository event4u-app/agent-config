...
- [x] **Step 1:** Extend both UI rules' path triggers beyond Laravel — `components/`, `src/components/`, `app/`, `pages/` — plus file patterns for `*.vue`, `*.svelte`, `*.tsx`, `*.jsx`. <!-- verify: npx vitest run tests/scripts/ui_rule_triggers.test.ts -->
