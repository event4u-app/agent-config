...
> the red test that would qualify each under ADR-206 Amendment D), 5 STAY.
>
> **Resume when:** the ADR-206 exit fires (external adopter OR the internal
> arm), AND each resumed milestone satisfies ADR-206 Amendment C (pre-dating
