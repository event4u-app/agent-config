...
> the red test that would qualify each under ADR-210 Amendment D), 5 STAY.
>
> **Resume when:** the ADR-210 exit fires (external adopter OR the internal
> arm), AND each resumed milestone satisfies ADR-210 Amendment C (pre-dating
