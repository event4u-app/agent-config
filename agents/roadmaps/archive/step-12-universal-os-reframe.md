...
- [~] [`step-9-user-types-axis.md`](step-9-user-types-axis.md) authored 2026-05-15 (closure run #2) — `user-types/` directory + 7 seed YAMLs + README shipped this PR; `--user-type` flag + runtime filter tracked in step-9 Phases 2–5. AI-Council 2026-05-15-step12-closure-run2 verdict D1 ACCEPT (both members) with amendment "seed all 7 not 3" (honored).
