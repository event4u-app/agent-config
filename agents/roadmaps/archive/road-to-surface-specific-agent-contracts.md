...
- [x] Create or extend a spreadsheet skill with these floors: formulas over
...
- [x] Add a `spreadsheet-source-quality` rule or contract for financial data:
...
- [x] Add capability-aware degradation: when native spreadsheet tooling is
...
- [x] Add eval fixtures: formula overwritten with value, sourced number with
...
- [x] Add deck-specific floors: outline before slide build, audience/tone
...
- [x] Add document-specific floors: choose markdown/docx/pdf based on user
...
- [x] Add print/PDF floor: do not rasterize text-heavy documents when browser
      print or native document export can preserve selectable text.
- [x] Add capability-aware degradation for export verification and native
      format editing.
- [x] Add evals for deck with missing speaker notes, tiny slide text,
...
- [x] Spreadsheet, deck/document, browser/connector, mobile/chat, and code
