...
**Status:** COMPLETED 2026-05-08 — shipped on
`feat/road-to-structural-linter-reform`. All four phases delivered;
contract locked at
[`docs/contracts/linter-structural-model.md`](../../docs/contracts/linter-structural-model.md);
calibration sweep recorded a 88 % drop in size-related warnings (34 →
4) on the 310-artifact corpus.
...
- [x] **1.1 Density score.** Define a density score per artifact
      ...
      distribution.
- [x] **1.2 Multi-workflow detector for skills.** Detect when a skill
...
- [x] **1.3 Delegation detector for commands.** Detect when a command
...
- [x] **1.4 Iron-Law block recogniser for rules.** Detect verbatim
...
- [x] **2.1 Decide: optional `iron_law: true` frontmatter** for rules
...
- [x] **4.1 Re-run lint on all 289 artifacts.** Record before/after
