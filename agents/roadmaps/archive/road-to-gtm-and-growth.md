...
- [x] **G** — GTM cognition foundation shipped (block marker; flips when G1–G3 are all done). Gated on unified-senior-roles K ≥ 100 % AND sibling Block A ≥ 50 %.
