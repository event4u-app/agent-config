...
- [x] AC-6 — A decision record states that a route this package did not pay for may propose and may score but may never decide, and `evaluator-independence` cites it. <!-- 2.3 · ADR-256 (accepted, `reopen_policy: directional`); cited at `src/rules/evaluator-independence.md:148` and carried into the projection. -->
