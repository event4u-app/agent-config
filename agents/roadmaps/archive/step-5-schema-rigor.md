...
- [-] **Step 4 — Migration report archived:** Append the final `agents/runtime/metrics/migration-report.md` to `agents/evidence/audits/2026-05-14-north-star/` for historical record.
