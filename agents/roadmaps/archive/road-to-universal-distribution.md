...
> Make the cloud bundle reachable. Three concrete channels: Claude Code Plugin Marketplace (already noted in `agents/evidence/analysis/compare-anthropics-skills.md`), direct Claude.ai upload, Linear paste.
