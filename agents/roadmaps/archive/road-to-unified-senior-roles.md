...
| Skill-linter rules (`lint-skills` task) | Sibling Block B + this Block K2 + suite-closure Phase 2.4 | K2 **extends** the linter; canonical contract is `.agent-src.uncondensed/rules/skill-quality.md` § Senior-Tier Required Structure (path corrected from `docs/contracts/skill-quality.md` in suite-closure Phase 2) |
