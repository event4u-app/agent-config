...
| 6 | Quorum 1-of-2 lets one model wave through what two should judge | product | Majority at n=2 is a single voice | Council-weighed trade-off: the alternative (2-of-2) deadlocks a release gate on any timeout; inconclusive-holds keeps the human in the loop, and attendance telemetry makes absent members visible rather than silent | Phase 3 |
