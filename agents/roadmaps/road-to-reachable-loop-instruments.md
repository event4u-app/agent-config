...
- [ ] **0.1 Write `src/config/loop-surfaces.yaml`** listing the five verified loop surfaces —
...
- **What to do:** decide whether the inventory is its own `src/config/loop-surfaces.yaml` or a
