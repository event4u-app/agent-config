...
- [ ] [`road-to-rule-quality-research.md`](road-to-rule-quality-research.md) exists as the empirical companion for rule/judge quality
...
| Judge quality research | [`road-to-rule-quality-research.md`](road-to-rule-quality-research.md) Problem 2 | Judges on always-rules is the research PoC |
...
- Sibling roadmaps: [`road-to-anthropic-alignment.md`](road-to-anthropic-alignment.md), [`road-to-trigger-evals.md`](road-to-trigger-evals.md), [`road-to-rule-quality-research.md`](road-to-rule-quality-research.md), [`road-to-drafting-protocol.md`](road-to-drafting-protocol.md)
