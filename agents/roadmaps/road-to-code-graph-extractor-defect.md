...
- [ ] **Step 0.1:** add the missing TypeScript declaration forms to
      ...
      returns 0.
- [ ] **Step 0.2:** make the engine honour the dispatcher's root. Either read
      ...
      2026-08-22).
- [ ] **Step 0.3:** evaluate the pre-falsifier and write the verdict down
...
- [ ] AC-1 — The five-form fixture builds to 5 of 5 TS symbol nodes and 3 of 3
      ...
      baseline.
- [ ] AC-2 — `agent-config code-graph build --root <path>` produces a graph
...
- [ ] AC-4 — `code_graph.enabled` is unchanged unless the cleared arm fired and
