...
# Stub: road to the residual-interruption measurement

> **Stub — not active work.** A **drain-run transfer**, created 2026-09-06 when
...
> and this stub judges that claim rather than restating it.
...
| Report residual interruptions over a window wide enough to mean something, and judge the claim | **deferred to this stub** |
...
reason it is a stub rather than an open step.
...
means the stub is re-dated rather than reopened.
...
must not mean passive neglect: this stub keeps a named owner and a check that
