...
| 12 | [road-to-request-scoped-rule-load.md](roadmaps/road-to-request-scoped-rule-load.md) | 6 | 33 | 11 | 22 | 0 | 0 | [1](#blockers-road-to-request-scoped-rule-load) | ███████░░░ 67% |
...
**Road to request-scoped rule load — ship only what the request needs** — 22 / 33 done (67%)
...
| 1b | Pipeline B: make scoping reach actual consumer installs | 🟡 in progress | 3 | 2 | 0 | 0 | 40% |
