...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-typescript-only-scripts.md](roadmaps/road-to-typescript-only-scripts.md) | 12 | 65 | 46 | 19 | 0 | 0 | ███░░░░░░░ 29% |
...
**TypeScript-only scripts — full Python → TypeScript migration** — 19 / 65 done (29%)
