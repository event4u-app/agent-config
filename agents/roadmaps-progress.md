...
| 8 | [road-to-routing-correctness.md](roadmaps/road-to-routing-correctness.md) | 4 | 15 | 5 | 9 | 1 | 0 | 0 | ██████░░░░ 64% |
...
**Road to routing correctness — the rule set stops fighting itself, and a command proves what routes** — 9 / 14 done (64%)
