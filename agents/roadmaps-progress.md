...
| 5 | [road-to-ticket-bundles.md](roadmaps/road-to-ticket-bundles.md) | 7 | 34 | 1 | 28 | 0 | 5 | ██████████ 97% |
...
**Ticket bundles — high-tier plans, lite-tier builds** — 28 / 29 done (97%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Foundation — format, schema, ADR-101, asset policy | ✅ done | 0 | 6 | 0 | 0 | 100% |
| 1 | Two independent probes (the build-pilot is the GATE) | ✅ done | 0 | 1 | 0 | 1 | 100% |
...
| 5 | Tracker handoff — paste / MCP (no API export, ADR-102) | ⏭️ skipped | 0 | 0 | 0 | 4 | 0% |
| 6 | Traceability spine + status sync + dashboard | 🟡 in progress | 1 | 9 | 0 | 0 | 90% |
