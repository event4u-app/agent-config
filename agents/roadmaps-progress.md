...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-context-aware-command-suggestion.md](roadmaps/road-to-context-aware-command-suggestion.md) | 7 | 45 | 1 | 44 | 0 | 0 | ██████████ 98% |
...
**Context-Aware Command Suggestion** — 44 / 45 done (98%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Eligibility audit and trigger drafting | ✅ done | 0 | 5 | 0 | 0 | 100% |
| 2 | Frontmatter schema and migration | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 3 | Matcher engine and suggestion rule | ✅ done | 0 | 5 | 0 | 0 | 100% |
| 4 | Tie-break and anti-noise | ✅ done | 0 | 3 | 0 | 0 | 100% |
| 5 | Settings and opt-out paths | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 6 | Hardening — what suggestion must never do | ✅ done | 0 | 6 | 0 | 0 | 100% |
| 7 | Golden tests, verification, docs | 🟡 in progress | 1 | 17 | 0 | 0 | 94% |
