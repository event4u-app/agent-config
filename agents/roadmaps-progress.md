...
>
> 9 open roadmaps · [roadmaps/](roadmaps/) · [archive/](roadmaps/archive/) · [skipped/](roadmaps/skipped/) · [later/](roadmaps/later/) · **6** open blockers

## Overall

**85 / 141 steps done · 60%**
...
|---|---:|---:|---:|
| [road-to-opt-harness-discipline.md](roadmaps/road-to-opt-harness-discipline.md) | 13 | 1 | 0 |
...
| 4 | [road-to-opt-harness-discipline.md](roadmaps/road-to-opt-harness-discipline.md) | 5 | 14 | 0 | 13 | 1 | 0 | 0 | ██████████ 100% |
...
**Road to opt harness discipline — port the native-harness behaviors weaker hosts don't have** — 13 / 13 done (100%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | deterministic environment bootstrap (S) | ✅ done | 0 | 3 | 0 | 0 | 100% |
| 2 | machine-checkable step verification (M) | ✅ done | 0 | 3 | 0 | 0 | 100% |
| 3 | error-signature triage in the failure counter (S) | ✅ done | 0 | 3 | 0 | 0 | 100% |
| 4 | promote the fable draft rules as cross-tool harness ports (S) | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 5 | style-contract tension: decision step (no silent resolve) | ⏭️ skipped | 0 | 0 | 1 | 0 | 0% |
