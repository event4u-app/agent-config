...
| 2 | [road-to-6.0.x-workspace-structural-cleanup.md](roadmaps/road-to-6.0.x-workspace-structural-cleanup.md) | 2 | 10 | 9 | 1 | 0 | 0 | █░░░░░░░░░ 10% |
...
**Road to 6.0.x — Workspace structural cleanup (the deferred Step-16 remainder)** — 1 / 10 done (10%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Complete the `packages/` dual-tree collapse (finish Step 10) | 🟡 in progress | 2 | 1 | 0 | 0 | 33% |
| 2 | Resolve the `agents/` namespace + runtime coupling | ⬜ not started | 7 | 0 | 0 | 0 | 0% |
