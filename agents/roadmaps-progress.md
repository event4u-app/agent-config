...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-golden-transcript-ts-replatform.md](roadmaps/road-to-golden-transcript-ts-replatform.md) | 6 | 14 | 3 | 11 | 0 | 0 | ████████░░ 79% |
...
**Road to a TypeScript Golden-Transcript Replay (py2ts Phase 12 follow-up)** — 11 / 14 done (79%)
...
| 5 | Re-capture baselines + replay test + CI — DONE 2026-06 | ✅ done | 0 | 3 | 0 | 0 | 100% |
