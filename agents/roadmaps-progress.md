...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-py2ts-teardown-completion.md](roadmaps/road-to-py2ts-teardown-completion.md) | 4 | 13 | 13 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
**Road to py2ts Teardown Completion** — 0 / 13 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Purge the remaining live-python test layer | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 2 | CI + scaffolding cleanup (unblocked by Phase 1) | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 2b | AI-council live-call layer (py2ts gap, discovered 2026-06) | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
