...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-claude-skills-untrack.md](roadmaps/road-to-claude-skills-untrack.md) | 4 | 13 | 13 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
| 5 | [road-to-test-and-gate-integrity.md](roadmaps/road-to-test-and-gate-integrity.md) | 3 | 14 | 14 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
| 6 | [road-to-video-from-song.md](roadmaps/road-to-video-from-song.md) | 6 | 33 | 3 | 30 | 0 | 0 | █████████░ 91% |

---

## Per-roadmap phase breakdown

### [road-to-claude-skills-untrack.md](roadmaps/road-to-claude-skills-untrack.md)

**Untrack `.claude/skills/` (follow-up to projection cleanup)** — 0 / 13 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Spike: does Claude Code register skills off `.agent-src/skills/`? | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 2 | Decision gate (ADR) | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
| 3 | Implement (conditional on Phase 2) | ⬜ not started | 5 | 0 | 0 | 0 | 0% |
| 4 | Verify | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
...
### [road-to-session-profile-activation.md](roadmaps/road-to-session-profile-activation.md)

**Road to Session-Profile Activation** — 0 / 16 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Lock semantics + host-capability audit (BLOCKING) | ⬜ not started | 5 | 0 | 0 | 0 | 0% |
