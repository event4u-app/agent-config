...
| 5 | [road-to-native-code-intelligence.md](roadmaps/road-to-native-code-intelligence.md) | 7 | 26 | 26 | 0 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
**Road to native code intelligence — own the engine, sweep the rejected inventory, keep the gates** — 0 / 26 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | ADR-124 landing + contract reconciliation | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
