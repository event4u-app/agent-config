...
| 5 | [road-to-native-code-intelligence.md](roadmaps/road-to-native-code-intelligence.md) | 7 | 27 | 11 | 15 | 0 | 1 | 0 | ██████░░░░ 58% |
...
**Road to native code intelligence — own the engine, sweep the rejected inventory, keep the gates** — 15 / 26 done (58%)
...
| 2 | Native engine v1: extract + build (Class A) | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 3 | Query tier: one engine, two sources | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 4 | Behavior wiring: make agents actually use it | 🟡 in progress | 4 | 1 | 0 | 0 | 20% |
| 5 | Honest benchmark → default decision | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 6 | Close-out | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
