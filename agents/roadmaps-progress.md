...
>
> 32 open roadmaps · [roadmaps/](roadmaps/) · [archive/](roadmaps/archive/) · [skipped/](roadmaps/skipped/) · [later/](roadmaps/later/) · **40** open blockers in the active tree, **19** need you → `agent-config gates`

## Overall

**330 / 564 steps done · 59%**
...
| [road-to-source-first-frontend.md](roadmaps/road-to-source-first-frontend.md) | 16 | 16 |
| [road-to-user-out-of-the-loop.md](roadmaps/road-to-user-out-of-the-loop.md) | 30 | 30 |
...
| 28 | [road-to-standing-context-40k.md](roadmaps/road-to-standing-context-40k.md) | 5 | 9 | 4 | 3 | 1 | 1 | [1](#blockers-road-to-standing-context-40k) | ████░░░░░░ 43% |
...
| 32 | [road-to-user-out-of-the-loop.md](roadmaps/road-to-user-out-of-the-loop.md) | 10 | 44 | 0 | 30 | 0 | 14 | 0 | ██████████ 100% |
...
**Road to user-out-of-the-loop** — 30 / 30 done (100%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 8 | Step 1, narrowed — which of the eight metrics have instruments | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 0 | Measurement foundation | ✅ done | 0 | 3 | 0 | 0 | 100% |
| 1 | One elicitation surface | ✅ done | 0 | 6 | 0 | 1 | 100% |
| 2 | Set scope, serial then parallel | ✅ done | 0 | 3 | 0 | 2 | 100% |
| 3 | Merge decoupling | ✅ done | 0 | 1 | 0 | 2 | 100% |
| 4 | Question-elimination ladder | ✅ done | 0 | 5 | 0 | 0 | 100% |
| 5 | Asynchronous disposition of deferred items | ✅ done | 0 | 2 | 0 | 0 | 100% |
| 6 | Session continuity | ✅ done | 0 | 2 | 0 | 2 | 100% |
| 7 | Unattended backlog operation | ✅ done | 0 | 1 | 0 | 2 | 100% |
| 8 | Standing measurement | ✅ done | 0 | 3 | 0 | 5 | 100% |
