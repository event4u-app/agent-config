...
>
> 18 open roadmaps · [roadmaps/](roadmaps/) · [archive/](roadmaps/archive/) · [skipped/](roadmaps/skipped/) · [later/](roadmaps/later/) · **14** open blockers

## Overall

**168 / 299 steps done · 56%**
...
| 4 | [road-to-council-blind-review.md](roadmaps/road-to-council-blind-review.md) | 3 | 6 | 6 | 0 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
| 12 | [road-to-provenance-and-license-governance.md](roadmaps/road-to-provenance-and-license-governance.md) | 6 | 22 | 22 | 0 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
| 16 | [road-to-surface-consolidation.md](roadmaps/road-to-surface-consolidation.md) | 2 | 13 | 5 | 6 | 2 | 0 | [3](#blockers-road-to-surface-consolidation) | ██████░░░░ 55% |
| 17 | [road-to-team-mode.md](roadmaps/road-to-team-mode.md) | 7 | 39 | 6 | 31 | 2 | 0 | [2](#blockers-road-to-team-mode) | ████████░░ 84% |
| 18 | [road-to-tier-removal.md](roadmaps/road-to-tier-removal.md) | 4 | 7 | 5 | 2 | 0 | 0 | 0 | ███░░░░░░░ 29% |
...
**Council Blind Review — three small deliberation-protocol adoptions from an external five-advisor prompt pattern** — 0 / 6 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Protocol diff (no model calls) | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
| 2 | Re-run test on existing artifacts (minimal spend) | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
| 3 | Landing & close | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
...
**Road to provenance and license governance — code borrows get a paper trail** — 0 / 22 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Golden corpus + baseline (gate for everything) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 1 | Behavioral layer (rules + skill; zero external deps) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 2 | Deterministic detection layer (the verifier) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 3 | Claims + measurement | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 4 | Dogfood + hygiene (practice before preach) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 5 | IP-Critic vertical (conditional; sparring-critic unpark) | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
