...
| 2 | [road-to-root-layout-cleanup.md](roadmaps/road-to-root-layout-cleanup.md) | 3 | 20 | 7 | 13 | 0 | 0 | ██████░░░░ 65% |
...
### [road-to-root-layout-cleanup.md](roadmaps/road-to-root-layout-cleanup.md)

**Root layout cleanup — targeted prune now, multi-workspace gated on four audits** — 13 / 20 done (65%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Targeted Prune — move three maintainer-internal dirs to `./internal/` | ✅ done | 0 | 13 | 0 | 0 | 100% |
| 2 | Pre-audits — gate Phase 3 | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 3 | Conditional multi-workspace (deferred, gated on Phase 2) | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
