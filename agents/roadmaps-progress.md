...
| 4 | [road-to-value-dashboard-netto-cuts.md](roadmaps/road-to-value-dashboard-netto-cuts.md) | 6 | 28 | 28 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
### [road-to-value-dashboard-netto-cuts.md](roadmaps/road-to-value-dashboard-netto-cuts.md)

**Value Dashboard NETTO — cut the base-load, keep Panel B value** — 0 / 28 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Fix the load-rung measurement (honest baseline) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 2 | Minify `dist/router.json` (lossless, zero-risk) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 3 | Router-trigger telemetry hook + Panel B attribution (force-multiplier) | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 4 | Targeted trigger deduplication (delete-only) | ⬜ not started | 6 | 0 | 0 | 0 | 0% |
| 5 | Tier-1 dead-rule audit (telemetry + Panel B gated) | ⬜ not started | 6 | 0 | 0 | 0 | 0% |
| 6 | Final regression check + dashboard close-out | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
