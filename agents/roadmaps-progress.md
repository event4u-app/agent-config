...
| 3 | [road-to-portable-runtime-and-update-check.md](roadmaps/road-to-portable-runtime-and-update-check.md) | 4 | 28 | 28 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
### [road-to-portable-runtime-and-update-check.md](roadmaps/road-to-portable-runtime-and-update-check.md)

**Road to npx-only Distribution + Hierarchical Settings + Update Check** — 0 / 28 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Remove npm + Composer distribution, ship npx-only with version-pin | ⬜ not started | 8 | 0 | 0 | 0 | 0% |
| 1 | Hierarchical settings + `agents/` overlay | ⬜ not started | 8 | 0 | 0 | 0 | 0% |
| 2 | Daily update-check banner | ⬜ not started | 5 | 0 | 0 | 0 | 0% |
| 3 | `agent-config update` + version-pin resolver + `migrate` | ⬜ not started | 7 | 0 | 0 | 0 | 0% |
