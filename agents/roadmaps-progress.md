...
| [road-to-ui-track-integrity-followup.md](roadmaps/road-to-ui-track-integrity-followup.md) | 1 | 1 |
...
| 31 | [road-to-ui-track-integrity-followup.md](roadmaps/road-to-ui-track-integrity-followup.md) | 1 | 10 | 0 | 1 | 0 | 9 | 0 | ██████████ 100% |
...
**Road to UI-track integrity — follow-up: two measurements, one missing harness** — 1 / 1 done (100%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Two measurements against the same harness | ✅ done | 0 | 1 | 0 | 9 | 100% |
