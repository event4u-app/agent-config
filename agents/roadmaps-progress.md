...
| 12 | [road-to-request-scoped-rule-load.md](roadmaps/road-to-request-scoped-rule-load.md) | 6 | 33 | 10 | 23 | 0 | 0 | [1](#blockers-road-to-request-scoped-rule-load) | ███████░░░ 70% |
...
**Road to request-scoped rule load — ship only what the request needs** — 23 / 33 done (70%)
...
| 1b | Pipeline B: make scoping reach actual consumer installs | 🟡 in progress | 2 | 3 | 0 | 0 | 60% |
