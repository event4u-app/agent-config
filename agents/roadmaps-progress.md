...
| 5 | [road-to-mcp-full-power.md](roadmaps/road-to-mcp-full-power.md) | 6 | 35 | 22 | 12 | 1 | 0 | [1](#blockers-road-to-mcp-full-power) | ████░░░░░░ 35% |
...
**CI-native release — retire `task release`** — 0 / 33 done (0%)
...
| 6 | Remove `task release` + documentation sweep | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 7 | End-to-end validation + rollback safety | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
...
**MCP Full Power — Glama leverage, coverage expansion, execution bridge** — 12 / 34 done (35%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Grounding & hygiene | ✅ done | 0 | 6 | 0 | 0 | 100% |
| 2 | Glama & registry leverage | ✅ done | 0 | 5 | 1 | 0 | 100% |
| 3 | Unlock gates — A0 amendment + council-gated cut | 🟡 in progress | 3 | 1 | 0 | 0 | 25% |
...
<a id="blockers-road-to-mcp-full-power"></a>
**Blockers**

- **a0-amendment-signoff** (owner: user) — blocks Phase 3 — Unlock gates
  - **What to do:**
