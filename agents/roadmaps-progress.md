...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-agentic-headroom-benchmark.md](roadmaps/road-to-agentic-headroom-benchmark.md) | 4 | 7 | 7 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
### [road-to-agentic-headroom-benchmark.md](roadmaps/road-to-agentic-headroom-benchmark.md)

**agentic-headroom benchmark (v4) — long-horizon, does governance finally show?** — 0 / 7 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Build a small multi-module task class + CHEAP baseline go/no-go | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 1b | Host choice (adversarial, council Q5) | ⬜ not started | 1 | 0 | 0 | 0 | 0% |
| 2 | 4-arm run + attribution (only if Phase 1 shows headroom) | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
