...
| 10 | [road-to-renewal-foundation.md](roadmaps/road-to-renewal-foundation.md) | 3 | 21 | 11 | 8 | 0 | 2 | [1](#blockers-road-to-renewal-foundation) | ████░░░░░░ 42% |
...
**Road to renewal — Foundation (CI oracle, dead tree, token quick wins)** — 8 / 19 done (42%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | CI becomes a trustworthy oracle | 🟡 in progress | 1 | 7 | 0 | 2 | 88% |
| 2 | token quick wins (no lock touched) | 🟡 in progress | 5 | 1 | 0 | 0 | 17% |
