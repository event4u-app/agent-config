...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-event4u-namespace-and-claude-desktop.md](roadmaps/road-to-event4u-namespace-and-claude-desktop.md) | 6 | 36 | 36 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
**Road to `~/.event4u/agent-config/` namespace + real Claude Desktop deployment** — 0 / 36 done (0%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | Path centralization + helper module | ⬜ not started | 5 | 0 | 0 | 0 | 0% |
| 2 | Migrate remaining callsites | ⬜ not started | 6 | 0 | 0 | 0 | 0% |
| 3 | Auto-migration shim | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 4 | Real Claude Desktop ZIP bundle deployment | ⬜ not started | 5 | 0 | 0 | 0 | 0% |
