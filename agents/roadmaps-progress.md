...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-cost-profile-untangle.md](roadmaps/road-to-cost-profile-untangle.md) | 8 | 37 | 26 | 11 | 0 | 0 | ███░░░░░░░ 30% |
...
### [road-to-cost-profile-untangle.md](roadmaps/road-to-cost-profile-untangle.md)

**Untangle `cost_profile`** — 11 / 37 done (30%)

| # | Phase | State | Open | Done | Deferred | Cancelled | % |
|---|---|---|---:|---:|---:|---:|---:|
| 0 | Settings schema foundation (prevents recurrence) | ✅ done | 0 | 4 | 0 | 0 | 100% |
| 1 | Resolve the collision — memory gets its own key | ✅ done | 0 | 7 | 0 | 0 | 100% |
| 2 | Rename `cost_profile` → `rule_loading_tier` | ⬜ not started | 8 | 0 | 0 | 0 | 0% |
| 3 | Migration + grace period | ⬜ not started | 5 | 0 | 0 | 0 | 0% |
| 4 | Fix the `/cost:report` recommendation logic | ⬜ not started | 2 | 0 | 0 | 0 | 0% |
| 5 | Installer + setup wizard | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
| 6 | Documentation + disambiguation | ⬜ not started | 3 | 0 | 0 | 0 | 0% |
| 7 | Regenerate + verify | ⬜ not started | 4 | 0 | 0 | 0 | 0% |
