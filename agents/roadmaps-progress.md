...
>
> 35 open roadmaps · [roadmaps/](roadmaps/) · [archive/](roadmaps/archive/) · [skipped/](roadmaps/skipped/) · [later/](roadmaps/later/) · **43** open blockers, **9** need you → `agent-config gates`

## Overall

**295 / 471 steps done · 63%**
...
| 27 | [road-to-source-first-frontend.md](roadmaps/road-to-source-first-frontend.md) | 6 | 18 | 7 | 11 | 0 | 0 | 0 | ██████░░░░ 61% |
...
**Road to source-first frontend — when the code is available, the code is the data basis; a screenshot is validation** — 11 / 18 done (61%)
...
| 4 | The browser handover — extraction into files, inside the lock | 🟡 in progress | 2 | 1 | 0 | 0 | 33% |
