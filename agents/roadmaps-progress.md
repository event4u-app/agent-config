...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-typescript-only-scripts.md](roadmaps/road-to-typescript-only-scripts.md) | 12 | 65 | 40 | 25 | 0 | 0 | ████░░░░░░ 38% |
...
**TypeScript-only scripts — full Python → TypeScript migration** — 25 / 65 done (38%)
