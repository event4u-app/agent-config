...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | [road-to-typescript-only-scripts.md](roadmaps/road-to-typescript-only-scripts.md) | 12 | 65 | 44 | 21 | 0 | 0 | ███░░░░░░░ 32% |
...
**TypeScript-only scripts — full Python → TypeScript migration** — 21 / 65 done (32%)
...
| 4 | Linters & CI checks (101 files, ~17.4k LOC) | 🟡 in progress | 3 | 2 | 0 | 0 | 40% |
