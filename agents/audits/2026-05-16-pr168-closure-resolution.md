...
| `step-99-north-star-restructure` | **Critical Partial — authority context missing** | **verified — Council phantom finding** | closure prose clarified — actual change was `.agent-src.uncompressed/contexts/authority/`, not a `agents/contexts/` rename |
...
- `agents/roadmaps/archive/step-99-north-star-restructure.md` line 18 — clarified that the Restructure Wave added `.agent-src.uncompressed/contexts/authority/`, not a rename of `agents/contexts/`.
