# R2 completion review — stop-gate-detector-demotion
...
- agents/roadmaps/archive/road-to-stop-gate-honesty.md
...
Fill the findings table in `stop-gate-detector-demotion.findings.md`:
