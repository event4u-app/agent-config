...
`agents/roadmaps/later/road-to-plan-gates-measurement.md` both carry registers whose
...
4 `fixed`, 3 `deferred` to `agents/roadmaps/later/road-to-plan-gates-measurement.md`.
