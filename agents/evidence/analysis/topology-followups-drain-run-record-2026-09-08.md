...
# Drain-run record — `road-to-council-topology-evidence-followups`

> **Moved here verbatim from the roadmap, 2026-09-08.** The roadmap had grown to
> 796 lines, of which roughly 700 were six dated sections explaining why six
> successive runs did not execute it. That is evidence about the runs, not a
> plan, and a reader looking for the work had to scroll past all of it.
>
> Everything below is preserved unedited so that no measurement, correction or
> reversal is lost. **One thing in it is superseded and is not preserved as
> live:** the 2026-09-08 disposition's ruling that `status: carrier` makes a
> roadmap human-gated. ADR-262 deleted that status and the reasoning behind the
> ruling; the roadmap carries the correction.
>
> Read the roadmap for what is to be done. Read this for what was measured.
