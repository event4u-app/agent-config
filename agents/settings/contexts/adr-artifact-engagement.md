...
> **Context:** [`contexts/contracts/artifact-engagement-flow.md`](../../.agent-src.uncondensed/contexts/contracts/artifact-engagement-flow.md) ·
> [`road-to-artifact-engagement-telemetry.md`](../roadmaps/road-to-artifact-engagement-telemetry.md)
> **Recording rule:** [`artifact-engagement-recording`](../../.agent-src.uncondensed/rules/artifact-engagement-recording.md)
...
2. **Trigger-quality eval feedback** (`agents/reference/docs/trigger-evals-poc-findings.md`)
...
[`contexts/contracts/artifact-engagement-flow.md`](../../.agent-src.uncondensed/contexts/contracts/artifact-engagement-flow.md#privacy-and-redaction-contract).
...
- [`contexts/contracts/artifact-engagement-flow.md`](../../.agent-src.uncondensed/contexts/contracts/artifact-engagement-flow.md) — flow + privacy contract
- [`artifact-engagement-recording`](../../.agent-src.uncondensed/rules/artifact-engagement-recording.md) — when the agent records
