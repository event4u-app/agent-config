...
| `/context-create` | D: "document this part of the codebase", "create a context doc for X" · C: working in a module without an `agents/settings/contexts/` doc |
| `/context-refactor` | D: "update the context doc", "refresh this context document" · C: existing `agents/settings/contexts/*.md` referenced in prompt |
