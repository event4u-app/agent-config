...
Per-tool method ([`scripts/condense.py:_filter_tool_dirs`](../../src/scripts/condense.ts)):
...
[`scripts/measure_projection_bytes.py --regenerate`](../../src/scripts/measure_projection_bytes.ts)
...
- [`tests/test_condense.py`](../../tests/scripts/condense.test.ts) — covers
  the shared condense / generate-tools entrypoint and `_filter_tool_dirs`.
- [`scripts/measure_projection_bytes.py`](../../src/scripts/measure_projection_bytes.ts)
