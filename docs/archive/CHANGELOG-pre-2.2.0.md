# Changelog Archive — pre-2.2.0

> Frozen snapshot of all `event4u/agent-config` changelog entries from
> `2.1.0` and earlier, split out of the main [`CHANGELOG.md`](../../CHANGELOG.md)
> on 2026-05-13 per Phase 5 Step 2 of
> `agents/roadmaps/road-to-distribution-maturity.md`.
>
> **Read-only.** New entries land in `CHANGELOG.md` § "Era: 2.2.x".
> Entries here are not amended — git tags `2.1.0` and prior are the
...
> older entries pre-date that contract and remain in their original
> shape on purpose.
