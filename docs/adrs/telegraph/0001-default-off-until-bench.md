...
Telegraph-speak is a turn-time condensation dialect that trades English
...
The North-Star council ([`council-synthesis.md` § 7](../../../agents/evidence/audits/2026-05-14-north-star/council-synthesis.md))
...
**`telegraph.speak_scope` defaults `off`**. Carve-outs (security ·
...
[`docs/contracts/condensation-default-kill-criterion.md`](../../contracts/condensation-default-kill-criterion.md)
§ Rule lines 8–11.
...
3. Reversibility check passes (telegraph → English round-trip ≥ 95 %
...
- [`docs/contracts/condensation-default-kill-criterion.md`](../../contracts/condensation-default-kill-criterion.md) — kill-criterion contract.
