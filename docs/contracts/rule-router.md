...
Generated by `./scripts-run src/scripts/generate_host_cost_table` from `agents/evidence/analysis/standing-payload-by-host-2026-09.md`, pinned to `27daf4ec61e8d7d237756f5a8c82042692184c91`. Do not hand-edit between the markers.
...
|---|---|---|---:|---:|
| `augment` | `.augment/rules` | per-rule tree | 485568 | 121392 |
| `claude-code` | `.claude/rules` | per-rule tree | 485568 | 121392 |
| `cline` | `.clinerules` | per-rule tree | 485568 | 121392 |
| `copilot` | `.github/copilot-instructions.md` | single file | 7491 | 1873 |
| `cowork` | — | none | — | — |
| `cursor` | `.cursor/rules` | per-rule tree | 485568 | 121392 |
| `gemini` | `GEMINI.md` | single file | 2982 | 746 |
| `windsurf` | `.windsurfrules` | single file | 398569 | 99642 |
