...
Generated by `./scripts-run src/scripts/generate_host_cost_table` from `agents/evidence/analysis/standing-payload-by-host-2026-09.md`, pinned to `4f1970935696688ce330b88e745236071ff4e432`. Do not hand-edit between the markers.
...
|---|---|---|---:|---:|
| `augment` | `.augment/rules` | per-rule tree | 485726 | 121432 |
| `claude-code` | `.claude/rules` | per-rule tree | 485726 | 121432 |
| `cline` | `.clinerules` | per-rule tree | 485726 | 121432 |
| `copilot` | `.github/copilot-instructions.md` | single file | 7491 | 1873 |
| `cowork` | — | none | — | — |
| `cursor` | `.cursor/rules` | per-rule tree | 485726 | 121432 |
