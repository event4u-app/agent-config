...
Generated by `./scripts-run src/scripts/generate_host_cost_table` from `agents/evidence/analysis/standing-payload-by-host-2026-09.md`, pinned to `ca8b1d58ed15becb5874de745cb8fdb76764b6ab`. Do not hand-edit between the markers.
...
|---|---|---|---:|---:|
| `augment` | `.augment/rules` | per-rule tree | 485615 | 121404 |
| `claude-code` | `.claude/rules` | per-rule tree | 485615 | 121404 |
| `cline` | `.clinerules` | per-rule tree | 485615 | 121404 |
| `copilot` | `.github/copilot-instructions.md` | single file | 7491 | 1873 |
| `cowork` | — | none | — | — |
| `cursor` | `.cursor/rules` | per-rule tree | 485615 | 121404 |
