...
Generated by `./scripts-run src/scripts/generate_host_cost_table` from `agents/evidence/analysis/standing-payload-by-host-2026-09.md`, pinned to `6b5c5742ff1955d27bd12ae9ada207eb7e929b84`. Do not hand-edit between the markers.
...
|---|---|---|---:|---:|
| `augment` | `.augment/rules` | per-rule tree | 485819 | 121455 |
| `claude-code` | `.claude/rules` | per-rule tree | 485819 | 121455 |
| `cline` | `.clinerules` | per-rule tree | 485819 | 121455 |
| `copilot` | `.github/copilot-instructions.md` | single file | 7491 | 1873 |
| `cowork` | — | none | — | — |
| `cursor` | `.cursor/rules` | per-rule tree | 485819 | 121455 |
