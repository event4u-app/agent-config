...
- Condenseor implementation: [`scripts/condense.py`](../../src/scripts/condense.ts)
...
- Lint implementation: [`scripts/lint_trust_coherence.py`](../../src/scripts/lint_trust_coherence.ts)
