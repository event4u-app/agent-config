...
[`scripts/sync_yaml_rt.py`](../../src/scripts/sync_yaml_rt.ts) source. The
...
- [`scripts/sync_yaml_rt.py`](../../src/scripts/sync_yaml_rt.ts) — implementation; module docstring mirrors this file.
- [`scripts/sync_agent_settings.py`](../../src/scripts/sync_agent_settings.ts) — CLI driver and exit-code contract.
