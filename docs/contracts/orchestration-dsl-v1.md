...
Exit codes mirror [`lint_hook_manifest.py`](../../src/scripts/lint_hook_manifest.ts): `0` clean, `1` failure, `2` schema-load error.
...
- Linter: [`lint_orchestration_dsl.py`](../../src/scripts/lint_orchestration_dsl.ts).
