...
| `analyze` | 4 | `postmortem` · `premortem` · `decision` · `near-miss` · `incident` · `repo` | analysis-workbench cluster, registered in this table 2026-07-08 (pre-existing head + five framework subs); `repo` (registered 2026-07-08 as `reference-repo`, renamed 2026-09-07) — slug-neutral nest + pack move of the reference-analysis command (engineering-base → analysis-workbench, co-locating with its head) |
...
**Retired 2026-09-09 — `chat-history` (Phase 2).** The `/chat-history` head and
its `import` sub were removed under the owner's authorization, recorded as an
AUTHORIZED CAPABILITY LOSS in `road-to-continuity-writer-activation` step 3.4.
No equivalent restoration mechanism was established; recovery from retained
continuity records is manual.
