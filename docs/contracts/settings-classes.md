...
| `hooks.code_graph.enabled` (REMOVED 2026-09-07) | C | n/a | configures code that runs on every tool call | derivable — the index-detection probe the nudge already runs; no index means silence |
