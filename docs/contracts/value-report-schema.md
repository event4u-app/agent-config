...
[`scripts/_lib/value_report.py`](../../src/scripts/_lib/value_report.ts)
and consumed by [`scripts/render_value_md.py`](../../src/scripts/render_value_md.ts).
...
- **No saving label on negative.** A rung with `token_delta > 0` is a
  *cost* rung; a rung with `token_delta < 0` is a *saving* rung;
  ...
  ([`scripts/lint_value_dashboard.py`](../../src/scripts/lint_value_dashboard.ts))
...
- Rung normaliser — [`scripts/_lib/value_ladder.py`](../../src/scripts/_lib/value_ladder.ts)
- Report assembler — [`scripts/_lib/value_report.py`](../../src/scripts/_lib/value_report.ts)
- Renderer — [`scripts/render_value_md.py`](../../src/scripts/render_value_md.ts)
- Linter — [`scripts/lint_value_dashboard.py`](../../src/scripts/lint_value_dashboard.ts)
