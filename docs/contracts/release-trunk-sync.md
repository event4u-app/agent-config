...
The fast-forward is owned by [`scripts/release.py`](../../src/scripts/release.ts)
...
[`scripts/check_release_trunk_sync.py`](../../src/scripts/check_release_trunk_sync.ts)
...
- [`scripts/release.py`](../../src/scripts/release.ts) — release pipeline owner.
