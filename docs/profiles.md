...
[`src/agent-src/profiles/<id>.yml`](../src/agent-src/profiles/).
...
[Profile YAML](../src/agent-src/profiles/developer.yml) ·
...
[Profile YAML](../src/agent-src/profiles/content_creator.yml) ·
...
[Profile YAML](../src/agent-src/profiles/founder.yml) ·
...
`strict`.**
[Profile YAML](../src/agent-src/profiles/agency.yml) ·
...
[Profile YAML](../src/agent-src/profiles/finance.yml) ·
...
[Profile YAML](../src/agent-src/profiles/ops.yml) ·
[Role guide](getting-started-by-role.md#finance--ops-cfo-controller-ops-lead-founder-finance).

> **Universal AI Agent OS, not "for developers only".** The same
> orchestration core also drives non-software trades. Worked-example
> user types ship for [galabau](../src/agent-src/user-types/galabau-field-crew.md),
> [metalworking](../src/agent-src/user-types/metalworking-shop.md),
> [truck driving](../src/agent-src/user-types/truck-driver.md) —
> with a [scaffold](../src/agent-src/user-types/_template/) for
