...
[`.agent-src.uncondensed/profiles/<id>.yml`](../.agent-src.uncondensed/profiles/).
...
[Profile YAML](../.agent-src.uncondensed/profiles/developer.yml) ·
...
[Profile YAML](../.agent-src.uncondensed/profiles/content_creator.yml) ·
...
[Profile YAML](../.agent-src.uncondensed/profiles/founder.yml) ·
...
`strict`.**
[Profile YAML](../.agent-src.uncondensed/profiles/agency.yml) ·
...
[Profile YAML](../.agent-src.uncondensed/profiles/finance.yml) ·
...
[Profile YAML](../.agent-src.uncondensed/profiles/ops.yml) ·
[Role guide](getting-started-by-role.md#finance--ops-cfo-controller-ops-lead-founder-finance).

> **Universal AI Agent OS, not "for developers only".** The same
> orchestration core also drives non-software trades. Worked-example
> user types ship for [galabau](../.agent-src.uncondensed/user-types/galabau-field-crew.md),
> [metalworking](../.agent-src.uncondensed/user-types/metalworking-shop.md),
> [truck driving](../.agent-src.uncondensed/user-types/truck-driver.md) —
> with a [scaffold](../.agent-src.uncondensed/user-types/_template/) for
