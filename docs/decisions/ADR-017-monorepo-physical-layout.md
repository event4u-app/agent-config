...
- [`scripts/plan_physical_move.py`](../../src/scripts/plan_physical_move.ts) (plan + apply)
- [`scripts/verify_physical_move.py`](../../src/scripts/verify_physical_move.ts) (post-move diff vs. snapshot)
...
Implemented in [`scripts/plan_physical_move.py`](../../src/scripts/plan_physical_move.ts):
...
`artefacts[].path` values. [`scripts/verify_physical_move.py`](../../src/scripts/verify_physical_move.ts)
