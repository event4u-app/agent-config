...
4. **Forward-only enforcement.** The lint
   ([`scripts/lint_command_verbs.py`](../../src/scripts/lint_command_verbs.ts))
...
- [`scripts/lint_command_verbs.py`](../../src/scripts/lint_command_verbs.ts) — the forward-only single lint.
