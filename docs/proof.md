...
| 195 commands. | quant | `exec:check_artefact_count_messaging -> 0` | ✅ |
...
| 113 governed rules. | quant | `exec:check_artefact_count_messaging -> 0` | ✅ |
...
**Axis 1 — enforcement level per rule.** 113 rules · 15 blocking (13.3%) · 8 observer · 0 local-only · 86 undeclared (no `enforced_by` yet).
