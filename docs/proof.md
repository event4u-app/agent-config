...
| 112 governed rules. | quant | `exec:check_artefact_count_messaging -> 0` | ✅ |
...
**Axis 1 — enforcement level per rule.** 112 rules · 15 blocking (13.4%) · 8 observer · 0 local-only · 85 undeclared (no `enforced_by` yet).
