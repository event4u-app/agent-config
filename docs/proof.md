...
| 271 skills. | quant | `src/scripts/check_artefact_count_messaging.ts#Artefact-count messaging gate` | ✅ |
...
**20 backed claim(s)** — all evidence pointers resolve in CI.
...
We also publish our **debt**: 3 claim(s) are logged as
