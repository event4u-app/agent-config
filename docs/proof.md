...
| 107 governed rules. | quant | `exec:check_artefact_count_messaging -> 0` | ✅ |
...
| 281 skills. | quant | `exec:check_artefact_count_messaging -> 0` | ✅ |
