...
| Hook dispatch runs as one precompiled node process with all concerns in-process — measured p50 67–80 ms / p95  | prose or contract artefact — no exit code carries the verdict |
