...
| 0 of 26 backed ledger claims are machine-re-verifiable today — every evidence pointer is checked for existence | prose or contract artefact — no exit code carries the verdict |
