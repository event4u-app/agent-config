...
### claim: ui-conformance-behavioural-catch
- claim: Over the frozen ui-conformance fixture, the probe reports all four planted behavioural defects and raises zero findings for the one declared deviation, against a pre-registered screenshot arm that catches two of the same four and raises one.
- kind: quant
