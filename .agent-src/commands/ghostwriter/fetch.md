...
cluster: ghostwriter
sub: fetch
description: Build or refresh a public-figure voice profile at agents/reference/ghostwriter/<slug>.md from a URL or bare name; runs the public-figure attestation gate; delegates web-fetch / web-search to the host agent.
