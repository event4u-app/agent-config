...
superseded_by: judge solo
deprecated_in: "1.17.0"
---

> ⚠️  /judge-solo is deprecated; use /judge solo instead.
> Post-clustering rename of the legacy standalone `/judge`. This shim is retained for one release cycle (1.17.0 → next minor) and forwards to the same instructions below. See [`docs/contracts/command-clusters.md`](../../docs/contracts/command-clusters.md).
