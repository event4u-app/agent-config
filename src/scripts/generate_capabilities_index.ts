 ...
 *
 * Ported from the retired Python `generate_capabilities_index` (ADR-200).
...
// generate_capabilities_index → parents[2] is repo root.
...
export function build(): string {
    ...
    lines.push('#');
    lines.push('# GENERATED by generate_capabilities_index — do NOT hand-edit.');
    ...
    lines.push('');
    lines.push('meta:');
    lines.push('  generated_by: generate_capabilities_index');
    lines.push(
        '  purpose: ' + _scalar(
