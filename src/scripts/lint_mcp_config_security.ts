...
//
// Ported from the retired Python `src/scripts/lint_mcp_config_security.py` (ADR-200 —
...
export function main(argv: readonly string[] | null = null): number {
    ...
    return sl.report(findings, { check_label: 'mcp-config-security', scanned_roots: roots });
}
