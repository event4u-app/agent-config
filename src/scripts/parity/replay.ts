...
import { realpathSync, cpSync, existsSync, mkdtempSync, readdirSync, readFileSync, rmSync, statSync } from "node:fs";
...
function _isCliEntry(): boolean {
    ...
    try {
        ...
        const argv = realpathSync(path.resolve(process.argv[1]));
        return here === argv;
    } catch {
        return false;
    }
