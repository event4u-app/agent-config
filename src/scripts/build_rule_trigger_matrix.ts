 ...
 *
 * Ported from the retired Python `src/scripts/build_rule_trigger_matrix.py` (ADR-200,
...
function emit(): number {
    ...
    lines.push('**Generated by:** `src/scripts/build_rule_trigger_matrix.ts` — re-run after rule');
