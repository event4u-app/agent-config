        ...
        JSON.stringify(
            {
                _comment:
                    ...
                    'LOWERING POLICY: a legitimate drop (skills merged, redundant eval removed) is allowed ' +
                    'ONLY by editing a count downward WITH a logged reason in coverage-floor.README.md — ' +
                    'never by deleting the floor file or a tier key. See coverage-floor.README.md.',
                ...floor,
            },
            null,
            2,
