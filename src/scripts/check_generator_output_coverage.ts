...
const GENERATOR_OUTPUT_ROOTS = [
    ...
    { root: '.claude/skills', generator: 'generate_claude_skills + generate_plugin_command_skills + generate_claude_commands', tool: 'claude-code' },
    { root: '.claude/commands', generator: 'generate_claude_project_commands', tool: 'claude-code' },
