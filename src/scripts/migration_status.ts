 ...
 *
 * Usage:
 *   npx tsx migration_status [--out <path>]
 *
...
function renderDashboard(
    ...
    lines.push('');
    lines.push(
        `> Generated by \`migration_status\` — do not edit by hand. Timestamp: ${timestamp}`,
    );
    lines.push('');
    lines.push(
...
// Run the CLI only when executed directly (`npx tsx migration_status`),
