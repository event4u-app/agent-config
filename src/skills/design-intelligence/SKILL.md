...
description: "Grounded design brief from the adopted corpus — style, WCAG color tokens, typography, layout pattern, anti-patterns. Use on ui-design-brief or any which-style/palette/font/chart call; feeds fe-design."
domain: engineering
personas:
  - frontend-engineer
workspaces:
