 ...
 */
export function toolBinaries(id: string): readonly string[] {
 ...
 */
export function resolveToolBinary(id: string, pathEnv?: string): string | null {
...
function resolveBinaryPath(name: string, pathEnv: string): string | null {
