...
/** One layer to fingerprint: a label (stable across machines) and its root. */
export interface LayerInput {
    /** Stable label — `rules`, `skills`, … NOT an absolute path. */
    readonly label: string;
    /** Absolute directory. A missing directory contributes nothing. */
 ...
 */
export function fingerprintLayers(layers: readonly LayerInput[]): string {
 ...
 */
export function hostLayerInputs(userHome: string): LayerInput[] {
