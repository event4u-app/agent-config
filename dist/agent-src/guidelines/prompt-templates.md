...
Reference catalogue of prompt structures the [`prompt-optimizer`](../skills/prompt-optimizer/SKILL.md)
skill picks from during the **Develop** step of the 4-D methodology.
Cited by the [`refine-prompt`](../skills/refine-prompt/SKILL.md)
...
- [`prompt-optimizer`](../skills/prompt-optimizer/SKILL.md) — engine-outbound; cites this catalogue in its Develop step
- [`refine-prompt`](../skills/refine-prompt/SKILL.md) — engine-inbound; uses templates in `mini` mode for stack-aware shaping
- [`prompt-engineering-patterns`](../skills/prompt-engineering-patterns/SKILL.md) — production-LLM prompt patterns (sibling skill, not a catalogue)
