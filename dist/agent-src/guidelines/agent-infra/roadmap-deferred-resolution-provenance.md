...
Migrated from [`roadmap-progress-sync`](../../rules/roadmap-progress-sync.md)
...
[`active-remediation`](../../rules/active-remediation.md).
...
[`no-cheap-questions`](../../rules/no-cheap-questions.md) forbids. The
...
- [`roadmap-progress-sync`](../../rules/roadmap-progress-sync.md) — the live obligation, Iron Law 3 and the route table.
