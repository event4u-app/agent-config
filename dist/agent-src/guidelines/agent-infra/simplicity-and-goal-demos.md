...
Recognition surface for [`minimal-safe-diff § Anti-over-engineering`](../../rules/minimal-safe-diff.md)
...
[`minimal-safe-diff § Own-orphan cleanup`](../../rules/minimal-safe-diff.md#own-orphan-cleanup).
