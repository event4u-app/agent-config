...
description: "Writing or reviewing Tailwind CSS — utility-first, design tokens, no inline-style drift, responsive variants, dark mode — even on 'style this' or 'mach das hübsch'. Pairs with react-shadcn-ui."
personas:
  - frontend-engineer
domain: engineering
workspaces:
