 ...
 */
export function expandAnchor(anchor, home) {
    const h = home ?? homedir();
    if (anchor === '~')
        return h;
    if (anchor.startsWith('~/'))
        return join(h, anchor.slice(2));
 ...
 */
export function buildPlanFromWizard(inputs) {
...
//# sourceMappingURL=wizard-plan.js.map