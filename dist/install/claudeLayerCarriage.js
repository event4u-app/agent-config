...
export const CLAUDE_ARTEFACT_DIRS = {
    skills: '.claude/skills',
    personas: '.claude/personas',
    commands: '.claude/commands',
};
const _defaultHome = () => process.env['HOME'] ?? os.homedir();
/**
...
export function _resetClaudeLayerMemoForTest() {
    _memo.clear();
}
/** Absolute path to the host-global directory for one family. */
export function claudeLayerPath(family, home = _defaultHome()) {
 ...
 */
export function claudeLayerNames(family, home = _defaultHome()) {
...
function _readLayer(family, dir) {
    let entries;
    try {
 ...
 */
export function claudeLayerHolds(family, name, home = _defaultHome()) {
 ...
 */
export function claudeLayerCarries(family, names, home = _defaultHome()) {
 ...
 */
export function keepInProjectLayer(family, names, home = _defaultHome()) {
    const have = claudeLayerNames(family, home);
    if (have === null) {
        return [...names];
    }
...
//# sourceMappingURL=claudeLayerCarriage.js.map