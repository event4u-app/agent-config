 ...
 */
export const PROJECT_RULE_DIRS = {
 ...
 */
export function globalRuleLayerPath(toolId, home = process.env['HOME'] ?? os.homedir()) {
 ...
 * largest.
 */
export function globalRuleLayerNames(toolId, home = process.env['HOME'] ?? os.homedir()) {
 ...
 * no evidence.
 */
export function hostLayerCarries(toolId, ruleNames, home = process.env['HOME'] ?? os.homedir()) {
...
//# sourceMappingURL=globalRuleLayers.js.map