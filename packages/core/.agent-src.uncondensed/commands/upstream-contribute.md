...
Write the **uncondensed version** (full, verbose, human-readable).
Write the **condensed version** (token-efficient, 40-60% shorter for skills; 1:1 for rules/commands).

Condensed version MUST preserve:
