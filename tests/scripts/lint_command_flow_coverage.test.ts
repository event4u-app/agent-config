...
const TS_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'lint_command_flow_coverage.ts');
const PY_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'lint_command_flow_coverage.py');
...
describe.skipIf(!py3)('lint_command_flow_coverage — golden parity (python3 vs tsx)', () => {
