...
const TS_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'lint_examples.ts');
const PY_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'lint_examples.py');
...
describe.skipIf(!py3)('lint_examples — golden parity (python3 vs tsx)', () => {
