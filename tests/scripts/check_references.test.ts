...
const TS_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'check_references.ts');
const PY_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'check_references.py');
...
describe.skipIf(!py3)('check_references — golden parity (python3 vs tsx)', () => {
