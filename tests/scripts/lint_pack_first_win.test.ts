...
const TS_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'lint_pack_first_win.ts');
const PY_SCRIPT = path.join(REPO_ROOT, 'src', 'scripts', 'lint_pack_first_win.py');
...
describe.skipIf(!py3)('lint_pack_first_win — golden parity (python3 vs tsx)', () => {
