# Caveman Carve-out Fixtures — Phase 8.4 / 8.4b

Locked carve-out contract for the [`caveman-speak`](../../../.agent-src.uncompressed/rules/caveman-speak.md)
...
must survive byte-for-byte after caveman compression.
...
`tests/test_caveman_carveouts.py` — stdlib-only validator that
...
the protected regions, which means caveman compression is unsafe to
ship.
