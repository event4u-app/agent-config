"""Tests for scripts/validate_telegraph_carveouts.py — Phase 4 mechanical validator."""
...
sys.modules["validate_telegraph_carveouts"] = vcc
_SPEC.loader.exec_module(vcc)


# Fixture pairs: (pre, post, expect_pass). One per carve-out category.
PASS_PAIRS = [
    # 1. Code fence preserved; surrounding prose condensed.
    (
