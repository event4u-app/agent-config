...
Validates the [`telegraph-speak`](../.agent-src.uncondensed/rules/telegraph-speak.md)
...
Stdlib only. CI runner for `tests/golden/telegraph/`.
"""
...
from tests.golden.telegraph.fuzz_inputs import (
    CARVE_OUT_REGEX,
    generate_cases,
)

TELEGRAPH_DIR = Path(__file__).parent / "golden" / "telegraph"
...
def test_carveout_regex_identifies_all_expected_lines(fixture_name: str) -> None:
    ...
    fixture = TELEGRAPH_DIR / fixture_name
