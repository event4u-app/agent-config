...
**Schema:** `caveman-v2` (input-side; offline; chars→tokens via /4 heuristic)
**Script:** `scripts/bench_compress_memory.py`
...
| `.agent-src.uncompressed/templates/AGENTS.md` | thin-root-consumer-template | 2,272 | 2,382 | +110 | -4.84% |
